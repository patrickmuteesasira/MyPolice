        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="contact-form">
              <form id="contact" action="regback.php" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="code" type="text" class="form-control" id="email" placeholder="Enter your police code" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12">
                  Gender <br><br>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                    <input name="pass" type="password" class="form-control" id="email" placeholder="Enter Password" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>Already have account?: <a href="index.php">please login here</a></p>
            </div>
          </div>
        </div>
      </div>
